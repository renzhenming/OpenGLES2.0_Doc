...
#include "MagnifierTextureImageRender.h"


MagnifierTextureImageRender::MagnifierTextureImageRender(JNIEnv *env, jobject asset) {
    loader = new NativeAssetsLoader(env, asset);
}

MagnifierTextureImageRender::~MagnifierTextureImageRender() {

}

void MagnifierTextureImageRender::CreateSurface() {
    glClearColor(0.5f, 0.5f, 0.5f, 1.0f);
    int file_size = 0;
    unsigned char *vertex_shader_code = loader->LoadFile("magnifier_texture_image_vertex.vs",
                                                         file_size);
    unsigned char *fragment_shader_code = loader->LoadFile("magnifier_texture_image_fragment.fs",
                                                           file_size);
...
void MagnifierTextureImageRender::DrawFrame() {
